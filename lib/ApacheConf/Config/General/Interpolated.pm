#
# ApacheConf::Config::General::Interpolated - special Class based on ApacheConf::Config::General
#
...
package ApacheConf::Config::General::Interpolated;
$ApacheConf::Config::General::Interpolated::VERSION = "2.15";
...
# Import stuff from ApacheConf::Config::General
...
sub new {
  ...
  croak "Deprecated method ApacheConf::Config::General::Interpolated::new() called.\n"
       ."Use ApacheConf::Config::General::new() instead and set the -InterPolateVars flag.\n";
}
...
sub _interpolate  {
  ...
  # on the varstack.
  #
  # called directly by ApacheConf::Config::General::_parse_value()
  #
...
sub _interpolate_hash {
  ...
  # on the varstack.
  #
  # called directly by ApacheConf::Config::General::new()
  #
  my ($this, $config) = @_;
...
sub _var_array_stacker {
  ...
  foreach my $entry (@{$config}) {
    if (ref($entry) eq "HASH") {
      ...
      # with ApacheConf::Config::General, because they are not accessible by
...
ApacheConf::Config::General::Interpolated - Parse variables within Config files
