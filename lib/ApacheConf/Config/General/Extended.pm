#
# ApacheConf::Config::General::Extended - special Class based on ApacheConf::Config::General
#
...
# namespace
package ApacheConf::Config::General::Extended;

# yes we need the hash support of new() in 1.18 or higher!
use ApacheConf::Config::General 1.18;
...
# inherit new() and so on from ApacheConf::Config::General
@ISA = qw(ApacheConf::Config::General Exporter);

use strict;


$ApacheConf::Config::General::Extended::VERSION = "2.07";


sub new {
  croak "Deprecated method ApacheConf::Config::General::Extended::new() called.\n"
       ."Use ApacheConf::Config::General::new() instead and set the -ExtendedAccess flag.\n";
}
...
sub AUTOLOAD {
  ...
  #
  my($this, $value) = @_;
  my $key = $ApacheConf::Config::General::Extended::AUTOLOAD;  # get to know how we were called
...
ApacheConf::Config::General::Extended - Extended access to Config files
...
=head1 SYNOPSIS
 ...
 $conf = ApacheConf::Config::General->new(
...
Returns a new object (of ApacheConf::Config::General::Extended Class) from the given key.
Short example:
...
and already read it in using B<ApacheConf::Config::General::Extended::new()>, then you can get a
...
Then $obj will be empty, just like if you have had run this:
 ...
 $obj = ApacheConf::Config::General::Extended->new( () );
...
just this way, returning the ApacheConf::Config::General::Extended object it finds
...
Now we read it in and process it:
 ...
 my $conf = ApacheConf::Config::General::Extended->new("configfile");
...
If you access a non-existent key this way, ApacheConf::Config::General will croak an error.
